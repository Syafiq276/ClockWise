...
<div class="max-w-4xl mx-auto px-4 py-8">
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6 print:hidden">
        ...
        <div class="flex gap-2">
            <a href="{{ route('payslips.pdf', $payroll) }}" class="btn-success px-4 py-2 rounded-lg inline-flex items-center ripple">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                </svg>
                Download PDF
            </a>
            <button onclick="window.print()" class="btn-primary px-4 py-2 rounded-lg inline-flex items-center ripple">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
